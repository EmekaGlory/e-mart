  ...
  <head>
      ...
      <style>
        body{
          ...
          background-image: url(images/woman-1439909.jpg);
  ...
  <body>
      ...
      <table class="table">
        ...
        <tbody>
          <tr id="tr1">
            <th scope="row">1</th>
            <td><img src="images/men's casual hooded solid color sweater yellow.jpg" alt=""></td>
            <td>men's casual hooded solid color sweater yellow</td>
            <td>Yellow</td>
            <td>20 Pairs</td>
            <td>30 Pairs</td>
          ...
          <tr id="tr1">
            <th scope="row">2</th>
            <td><img src="images/ladies_gorgeuos_top.jpg" alt=""></td>
            <td>female gorgeuos top</td>
            <td>Pink</td>
            <td>10 Pair</td>
            <td>12 Pairs</td>
          ...
          <tr>
            <th scope="row">3</th>
            <td><img src="images/men's suit short sleeve.jpg" alt=""></td>
            <td>men's suit short sleeve</td>
            <td>White</td>
            <td>12 pais</td>
            <td>13 pairs</td>
          </tr>
          <tr>
            <th scope="row">4</th>
            <td><img src="images/classical mens sport suit causal.jpg" alt=""></td>
            <td>classical mens sport suit causal</td>
            <td>White</td>
            <td>2 pairs</td>
            <td>14 pairs</td>
          </tr>
          <tr>
            <th scope="row">5</th>
            <td><img src="images/turtleneck.jpg" alt=""></td>
            <td>turtleneck</td>
            <td>Black </td>
            <td>22 pairs</td>
            <td>14 pairs</td>
          ...
          <tr>
            <th scope="row">6</th>
            <td><img src="images/white crop b hoddie.jpg" alt=""></td>
            <td>white crop b hoddie</td>
            <td>White</td>
            <td>11 pairs</td>
            <td>100pairs</td>
          </tr>
          <tr>
            <th scope="row">7</th>
            <td><img src="images/long sleeved professional pants suite for women.jpg" alt=""></td>
            <td>long sleeved professional pants suite for women</td>
            <td>Red</td>
            <td>3 Pairs</td>
            <td>33 pairs</td>
          </tr>
          <tr>
            <th scope="row">8</th>
            <td><img src="images/boss lady.jpg" alt=""></td>
            <td>" Boss lady"</td>
            <td>Red</td>
            <td>22 Pairs</td>
            <td>11 pairs</td>
          ...
          <tr>
            <th scope="row">10</th>
            <td><img src="images/mens sport suit casual tracksuite for men.jpg" alt=""></td>
            <td>mens sport suit casual tracksuite for men</td>
            <td>Black </td>
            <td>11 Pairs</td>
            <td>14 Pairs</td>
          </tr>
